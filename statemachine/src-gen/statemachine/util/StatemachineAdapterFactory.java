...
public class StatemachineAdapterFactory extends AdapterFactoryImpl {
	...
	protected StatemachineSwitch<Adapter> modelSwitch = new StatemachineSwitch<Adapter>() {
		@Override
		public Adapter caseMyFSM(MyFSM object) {
			return createMyFSMAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link statemachine.MyFSM <em>My FSM</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMyFSMAdapter() {
		return null;
	}
