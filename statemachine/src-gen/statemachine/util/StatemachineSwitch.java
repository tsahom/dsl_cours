...
public class StatemachineSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case StatemachinePackage.MY_FSM: {
			MyFSM myFSM = (MyFSM) theEObject;
			T result = caseMyFSM(myFSM);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>My FSM</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>My FSM</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMyFSM(MyFSM object) {
		return null;
	}
